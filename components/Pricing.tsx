...
const TIERS: Tier[] = [
  {
    ...
    features: [
      ...
      'Per-case email alerts (analyst + service-desk) with digest batching',
      'Email support',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'Exportable case reports (incl. PDF) for your SOC 2 / ISO 27001 / GDPR evidence',
      'Monthly executive review, compiled from your cases',
      'Direct founder access for security & procurement questions',
    ],
